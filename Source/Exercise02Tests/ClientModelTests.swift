...
final class ClientModelTests: XCTestCase {
	...
	override func setUp() {
		...
		contact = Contact(name: "João da Silva", email: "joaosilva@gmail.com", phone: "21973459921", company: Company(name: "Coca-Cola", cnpj: "22951114000150", activeSince: "10/10/2010", isMei: true))
	}
